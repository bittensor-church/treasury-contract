...
def main():
    parser = argparse.ArgumentParser(description="Execute Typed Proposal")
    ...
    if args.type == 'native':
        ...
        fn = governor.functions.executeNativeTransfer(
        ...
        amount_wei = w3.to_wei(str(args.amount), 'ether')
        fn = governor.functions.executeERC20Transfer(
        ...
        fn = governor.functions.executeAlphaTransfer(
    ...
    print(f"--- EXECUTE: {args.type.upper()} TRANSFER ---")
