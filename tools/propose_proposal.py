...
def main():
    parser = argparse.ArgumentParser(description="Propose Typed Proposal")
    ...
    if args.type == 'native':
        ...
        fn = governor.functions.proposeNativeTransfer(
        ...
        amount_wei = w3.to_wei(str(args.amount), 'ether')
        fn = governor.functions.proposeERC20Transfer(
    ...
    print(f"--- PROPOSE: {args.type.upper()} TRANSFER ---")
